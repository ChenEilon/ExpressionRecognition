...
class Ui_MainWindow(object):
    def __init__(self, UiWelcomeWindow):
        self.uiWelcomeWindow = UiWelcomeWindow
    ...
    def guiActivate(self):
        ...
        self.uiWelcomeWindow.user_name.connect(self.user_name_slot)
...
class Ui_WelcomeWindow(QtCore.QObject):
    user_name = QtCore.pyqtSignal(object)
    
    # def __init__(self, window, ui):
        # self.MusicWindow = window
        # self.musicUi = ui
    
    def setupUi(self, WelcomeWindow):
        WelcomeWindow.setObjectName("WelcomeWindow")
        WelcomeWindow.resize(296, 210)
...
def main():
    ...
    welcomeUi = Ui_WelcomeWindow()
    print("Debug - setup welcome ui..")
    welcomeUi.setupUi(WelcomeWindow)
    
    MusicWindow = QtWidgets.QMainWindow()
    musicUi = Ui_MainWindow(welcomeUi)
